...
```json Registration file (shape)
{
  ...
  "owner": "0xA11CE...",
  "domain": "research.a-identity.dev",
  "registrationUri": "https://agents.a-identity.dev/1/registration.json"
}
```
...
```ts
const passport = await identity.resolve("research.a-identity.dev")
